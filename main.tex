...
\begin{frame}{Historical Context}
    ...
    \hspace{0.5cm}
    \column{0.6\textwidth}
    \begin{block}{Know it alls}
        \centering
        
        Einstein 1911 at Solvay Conference had to deal with cheeky Lorentz questioning the quantum hypothesis $E=nhv$ for atomic oscillators. 
    \end{block}  
        \vspace{0.5cm}
        ...
        \begin{figure}
            ...
            \caption{1911 Solvay Conference \textit{Windows Paint and Bill Gates}} 
        \end{figure}
    ...
    \column{0.4\textwidth}
        \begin{figure}
            ...
            \caption{1911 Solvay Conference \textit{Wikimedia Commons}}
        \end{figure}
...
\begin{frame}{Simplifying Terms}
    ...
    \column{0.4\textwidth}
        \begin{figure}
            ...
            \caption{Michael Berry (The man himself) \textit{Wikimedia Commons}}
        \end{figure}
    \end{columns}
\end{frame}
...
\begin{frame}{Born–Oppenheimer Approximation: Adiabatic Physics in Molecules}
    ...
    Electrons follow adiabatically $\leftrightarrow$ qubit states follow instantaneous ground state.  
    \end{block}
