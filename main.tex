...
<<<<<<< HEAD
\author{Niall Carbery, Fintan Hughes, Shane Sweetman}
\date{\today}
\institute{QM Projecct}
...
\date{\today}
\institute{QM Project}

% Custom commands
>>>>>>> d78bbb6e0a9fb43612f148ddda10454551d5b602
...
\begin{frame}{Niall's Slides Placeholder}
    Niall's slides 5 minutes allocated here.
\end{frame}
...
\begin{frame}{What is the Adiabatic Theorem?}
    ...
    \begin{itemize}
        ...
        \item Important in quantum chemistry, condensed matter physics
    \end{itemize}
\end{frame}
...
\begin{frame}{Orthonormality and Completeness}
...
\begin{frame}{Projecting onto Eigenstates}
    ...
    \begin{multline}
        \frac{\dot{c}_m}{i\hbar} e^{i\theta_m} - c_m\dot{\theta}_m e^{i\theta_m} + \frac{c_m}{i\hbar} e^{i\theta_m}\braket{m}{\dot{m}} \\
        + \sum_{n\neq m} \frac{c_n}{i\hbar} e^{i\theta_n}\braket{m}{\dot{n}} = c_m e^{i\theta_m} \frac{E_m}{i\hbar}
    \end{multline}
...
% New Section
\setbeamertemplate{footline}{}
\begin{frame}{Someone's Slides Placeholder}
    Someone's slides 5 minutes allocated here.
\end{frame}
...
\begin{frame}{Landau-Zener Model: Avoided Crossing Visualization}
    \begin{center}
<<<<<<< HEAD
        \includegraphics[width=0.85\textwidth]{figures/avoided_crossing.png}
=======
        \includegraphics[width=0.75\textwidth]{figures/avoided_crossing.png}
>>>>>>> d78bbb6e0a9fb43612f148ddda10454551d5b602
    \end{center}
...
<<<<<<< HEAD
        \item Far from crossing: diabatic states $\approx$ adiabatic eigenstates
        \item Near crossing: maximum mixing between states
=======
>>>>>>> d78bbb6e0a9fb43612f148ddda10454551d5b602
    \end{itemize}
\end{frame}
...
\begin{frame}{Visualizing the Ising Model: Max-Cut Example}
    \begin{center}
<<<<<<< HEAD
        \includegraphics[width=0.95\textwidth]{figures/maxcut_example.png}
=======
...
\begin{frame}{Energy Landscape: Solution Distribution}
    \begin{center}
        \includegraphics[width=0.75\textwidth]{figures/maxcut_distribution.png}
    \end{center}
...
\begin{frame}{Parameter Dependence: Effect of Tunneling Amplitude $\Delta$}
    \begin{center}
<<<<<<< HEAD
        \includegraphics[width=0.85\textwidth]{figures/delta_comparison.png}
=======
        \includegraphics[width=0.60\textwidth]{figures/delta_comparison.png}
>>>>>>> d78bbb6e0a9fb43612f148ddda10454551d5b602
    \end{center}
...
\begin{frame}{Further Reading}
    ...
    \begin{itemize}
        \item Born, M. \& Fock, V. (1928). "Beweis des Adiabatensatzes"
        \item Berry, M. V. (1984). "Quantal phase factors accompanying adiabatic changes"
        \item Wilczek, F. \& Zee, A. (1984). "Appearance of gauge structure in simple dynamical systems"
    \end{itemize}
    ...
    \textbf{Textbooks:}
    \begin{itemize}
        \item Griffiths \& Schroeter, "Introduction to Quantum Mechanics"
        \item Sakurai, "Modern Quantum Mechanics"
        \item Messiah, "Quantum Mechanics"
        \item Shankar, "Principles of Quantum Mechanics"
    \end{itemize}
    ...
    \textbf{Reviews:}
    \begin{itemize}
        \item Bohm et al., "The Geometric Phase in Quantum Systems" (2003)
        \item Albash \& Lidar, "Adiabatic Quantum Computation" (2018)
    \end{itemize}
\end{frame}
=======
>>>>>>> d78bbb6e0a9fb43612f148ddda10454551d5b602
