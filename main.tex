...
\begin{frame}{What is the Adiabatic Theorem?}
    ...
    \column{0.3\textwidth}
    \centering
    \animategraphics[autoplay, loop, width=\textwidth]{25}{figures/frames/slow_adiabatic_potential_animation_}{000}{099}
    \vspace{0.5cm}
    \animategraphics[autoplay, loop, width=\textwidth]{25}{figures/frames/slow_adiabatic_potential_animation_}{000}{099}
...
% Animation: frames extracted from the original GIF into figures/frames/
% Generated frames: slow_adiabatic_potential_animation_000.png ... _099.png
\animategraphics[autoplay, loop, width=0.7\textwidth]{25}{figures/frames/slow_adiabatic_potential_animation_}{000}{099}
