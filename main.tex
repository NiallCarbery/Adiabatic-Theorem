...
\begin{frame}{Historical Context}
    ...
    \begin{figure}
        ...
        \caption{\tiny Phase Space Ref. \textit{Thomas Foster}}
    \end{figure}
...
\begin{frame}{Formal Statement}
    \begin{theorem}[Quantum Adiabatic Theorem]
        ...
        \end{enumerate}
        Then the state at time $t$ is \cite{Kato1950, Griffiths2018, MITOCW2018}:
        \begin{equation}
...
% New Section
\begin{frame}{Adiabatic Quantum Computation \cite{Farhi2000, Albash2018, DWave2024}}
...
\begin{frame}{The Ising Model}
    ...
    \begin{figure}
        ...
        \caption{\tiny{Ising model as a lattice of spins \textit{Wikimedia Commons}}}
    \end{figure}
    \end{columns}
    \vspace{0.3cm}
...
Other Applications
    \begin{columns}
        \column{0.5\textwidth}
        \begin{block}{Counterdiabatic Driving}
    \begin{equation*}
        H_1(t) = \dot{\lambda}(t)\,A_\lambda
    \end{equation*}
        \end{block}
        \column{0.5\textwidth}
        
        \begin{block}{Motional Transport}
            \begin{equation*}
                \braket{m}{\dot{n}} = \frac{\bra{m}\dot{\Hhat}\ket{n}}{E_n - E_m}
            \end{equation*}
        \end{block}
    \end{columns}
    \vspace{0.5cm}
